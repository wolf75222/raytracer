...
public:
    ...
    RT_HOSTDEV AABB() {} // empty intervals by default
    ...
    // Bounds as min/max points for fast indexing
    ...
    // Optimized Williams et al. ray-box test using precomputed inv_dir
    ...
    // Legacy: Interval-based hit (for tests)
